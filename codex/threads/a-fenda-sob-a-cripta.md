...
- **[Irmão Aurélio](/npcs/irmao-aurelio.md)** quer entender o que o templo dele está
  segurando. É o dono deste fio.
- **Lathander**, na medida em que um deus é dono de alguma coisa: a aurora está gastando
  força para segurar a borda, e o templo está pagando por isso.
...
**Relógio:** a fenda não espera a mesa. Se a sessão 4 terminar sem estabilização, a borda
...
- Ecoa o desaparecimento de **Marea** — que sumiu, dizem, tentando impedir o colapso de um
  portal natural ligado à Lagoa Nymrath. Ver [Líria](/party/liria.md).
- Ecoa a morte de **Eron**, num território onde o espaço deixou de obedecer regras. Ver
  [Yara](/party/yara.md).
