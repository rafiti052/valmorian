...
sources:
  - resource: "/sources/sessao_3_estrutura_narrativa.md"
    ...
    author: "human:rafael"
generated: { by: claude-opus-5/gm-companion, at: 2026-08-15T22:40:00Z }
---
...
ossos e paramentos que ocupa o espaço dele e conta como terreno difícil. No **início do
próximo turno dele**, remonta no mesmo espaço com **11 pontos de vida**.

**O Coro.** Enquanto **3 ou mais** estiverem ativos, eles cantam juntos. Uma vez por rodada,
como ação bônus coletiva, remontam imediatamente uma pilha com 11 pontos de vida. Com dois
ou menos de pé, o canto se desfaz e isso deixa de funcionar.

**Fim verdadeiro.** Uma pilha desmontada para de remontar de vez se **sofrer dano radiante**
enquanto está no chão — ou se a fenda na [cripta](/locations/cripta.md) for estabilizada, o
que derruba os seis de uma vez.
...
**Verso Necrótico.** *Ataque mágico à distância:* +3 para acertar, alcance 60 pés, um alvo.
*Acerto:* 5 (2d4) de necrótico, e o alvo não recupera pontos de vida até o fim do próximo
turno dele.

## Notas de mesa

- **Vulnerabilidade a concussão** é do esqueleto padrão de 2024 e vale a pena lembrar: o
  martelo da nave, um banco arremessado, a **Língua da Bob** puxando um para a parede.
- **Hold Person da Líria não funciona.** Morto-vivo não é humanoide. Avise antes que ela
  gaste o espaço de 2º círculo.
